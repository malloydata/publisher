...
- **`malloy_reloadPackage`**: recompile a package from its on-disk model files so a source or view added after boot becomes queryable by name without restarting the server, closing the edit-and-run loop.

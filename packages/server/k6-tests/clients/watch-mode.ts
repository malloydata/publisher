 ...
 */
   getWatchStatus(requestParameters?: Params): {
      response: Response;
      data: WatchStatus;
   } {
      const url = new URL(this.cleanBaseUrl + `/watch-mode/status`);
 ...
 */
   startWatching(
      ...
      const url = new URL(this.cleanBaseUrl + `/watch-mode/start`);
      const mergedRequestParameters = this._mergeRequestParameters(
         requestParameters || {},
         this.commonRequestParameters,
      );
      const response = http.request(
         "POST",
         url.toString(),
         JSON.stringify(startWatchRequest),
         {
            ...mergedRequestParameters,
            headers: {
 ...
 */
   stopWatching(requestParameters?: Params): {
      response: Response;
      data: void;
   } {
      const url = new URL(this.cleanBaseUrl + `/watch-mode/stop`);
      const mergedRequestParameters = this._mergeRequestParameters(
         requestParameters || {},
         this.commonRequestParameters,
      );

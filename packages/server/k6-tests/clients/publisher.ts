...
import type { ServerStatus } from "./malloyPublisherSemanticModelServingAPI.schemas";
 ...
 */
   getStatus(requestParameters?: Params): {
      response: Response;
      data: ServerStatus;
   } {
      const url = new URL(this.cleanBaseUrl + `/status`);

 ...
 * it. The same shape the build plan reports under `refusedSources`, keyed by
 * sourceID in `BuildManifest.refused` because a refused source may have no
 * content address to key it by.
 */

...
export async function getSchemasForConnection(
   ...
   if (connection.type === "bigquery") {
      ...
      try {
         ...
         // Return dataset info directly without fetching metadata for each dataset.
         // Previously, getMetadata() was called per dataset just to get descriptions,
         // which caused N additional API roundtrips and made listSchemas very slow.

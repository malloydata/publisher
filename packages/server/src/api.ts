...
export interface paths {
   ...
   "/projects": {
      /**
       * List all available projects (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}": {
      /**
       * Get project details and metadata (deprecated)
       * @deprecated
      ...
      /**
       * Update project configuration (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/connections": {
      /**
       * List project database connections (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/connections/{connectionName}/schemas": {
      /**
       * List database schemas (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/connections/{connectionName}/schemas/{schemaName}/tables": {
      /**
       * List tables in database (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/connections/{connectionName}/schemas/{schemaName}/tables/{tablePath}": {
      /**
       * Get table details from database (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/connections/{connectionName}/sqlSource": {
      ...
      /**
       * Create SQL source from statement (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages": {
      /**
       * List project packages (deprecated)
       * @deprecated
      ...
      /**
       * Create a new package (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}": {
      /**
       * Get package details and metadata (deprecated)
       * @deprecated
      ...
      /**
       * Update package configuration (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/models": {
      /**
       * List package models (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/models/{path}": {
      /**
       * Get compiled Malloy model (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/models/{path}/query": {
      /**
       * Execute Malloy query (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/models/{path}/compile": {
      /**
       * Compile Malloy source code (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/notebooks": {
      /**
       * List package notebooks (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/notebooks/{path}": {
      /**
       * Get Malloy notebook cells (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/notebooks/{path}/cells/{cellIndex}": {
      /**
       * Execute a specific notebook cell (deprecated)
       * @deprecated
   ...
   "/projects/{projectName}/packages/{packageName}/databases": {
      /**
       * List embedded databases (deprecated)
       * @deprecated

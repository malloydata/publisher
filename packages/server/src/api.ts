...
export interface operations {
   ...
   "list-schemas": {
      parameters: {
         query?: {
            /**
             * @description Disambiguates per-package "duckdb" lookups in multi-package projects.
             * Required when connectionName is "duckdb" and the project has more
             * than one package; ignored otherwise.
             */

...
export interface paths {
  ...
  "/environments": {
     ...
     * @description Retrieves a list of all environments currently hosted on this Malloy Publisher server.
     ...
     * @description Creates a new Malloy environment with the specified configuration. An environment serves as a
  ...
  "/environments/{environmentName}": {
     ...
     * @description Retrieves detailed information about a specific environment, including its packages,
     ...
     * @description Permanently deletes an environment and all its associated resources including packages,
     ...
     * @description Updates the configuration and metadata of an existing environment. This allows you to
  ...
  "/environments/{environmentName}/connections": {
     ...
     * @description Retrieves a list of all database connections configured for the specified environment.
  ...
  "/environments/{environmentName}/connections/{connectionName}": {
     ...
     * @description Retrieves detailed information about a specific database connection within an environment.
  ...
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/schemas": {
     ...
     * @description Retrieves a list of all schemas (databases) available in the specified
     ...
     */
    get: operations["list-schemas-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/schemas/{schemaName}/tables": {
     ...
     * @description Retrieves a list of all tables and views available in the specified
     * database schema, resolved in the context of the named package.
     */
    get: operations["list-tables-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/schemas/{schemaName}/tables/{tablePath}": {
     ...
     * @description Retrieves a table from the specified database schema, resolved in
     * the context of the named package.
     */
    get: operations["get-table-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/sqlSource": {
    /**
     * Get SQL source (per-package, deprecated)
     * @deprecated
     ...
     */
    get: operations["get-sqlsource-in-package"];
    /**
     * Create SQL source from statement (per-package)
     * @description Creates a Malloy source from a SQL statement using the specified
     * connection, resolved in the context of the named package.
     */
    post: operations["post-sqlsource-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/sqlQuery": {
    /**
     * Execute SQL query (per-package)
     * @description Executes a SQL statement against the specified database connection,
     * resolved in the context of the named package, and returns the results.
     */
    post: operations["post-querydata-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/sqlTemporaryTable": {
     ...
     * @description Creates a temporary table from a SQL statement using the specified
     * database connection, resolved in the context of the named package.
     */
    post: operations["post-temporarytable-in-package"];
  };
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/temporaryTable": {
    /**
     * Create temporary table (per-package, deprecated)
     * @deprecated
     * @description **DEPRECATED**: Use the POST version instead.
     *
  ...
  "/environments/{environmentName}/packages/{packageName}/connections/{connectionName}/queryData": {
     ...
     * resolved in the context of the named package, and returns the results.
     */
    get: operations["get-querydata-in-package"];
  };
  "/environments/{environmentName}/packages": {
    /**
     * List environment packages
     * @description Retrieves a list of all Malloy packages within the specified environment. Each package
...
export interface components {
  schemas: {
    ...
    ServerStatus: {
       ...
       * @enum {string}
       */
      operationalState?: "initializing" | "serving" | "degraded" | "draining";
    ...
    Environment: {
      ...
      readme?: string;
      /** @description Environment location, can be an absolute path or URI (e.g. github, s3, gcs, etc.) */
      location?: string;
    ...
    Connection: {
       ...
       * @enum {string}
       */
      type?: "postgres" | "bigquery" | "snowflake" | "trino" | "databricks" | "mysql" | "duckdb" | "motherduck" | "ducklake";
...
export interface operations {
  ...
  "get-environment": {
    parameters: {
      ...
      path: {
        /** @description Name of the environment */
        environmentName: components["schemas"]["IdentifierPattern"];
      };
    };
    responses: {
   ...
   * database connection, resolved in the context of the named package.
   */
  "post-temporarytable-in-package": {
    parameters: {
      path: {
        /** @description Name of the environment */
        environmentName: components["schemas"]["IdentifierPattern"];

...
## Parameters
- environmentName, packageName, modelPath: required. source: required at append/file, optional at package. includeSql: append/file only. givens: model givens and authorize-gate values. Caller source may not declare an authorize gate — #(row_authorize), #(source_authorize), or the deprecated #(authorize).

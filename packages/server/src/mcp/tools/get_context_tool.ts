...
## Contract rules
- Use the names it returns verbatim; never invent an environment, package, or entity not in the results.
- Start broad and narrow down: environments, packages, sources, then a query.

...
export function NewDashboardDialog({
   ...
   return (
      <AppDialog
         ...
         onClose={onClose}
         title="New dashboard"
         description="A dashboard is a Malloy file in the package. Pick what its first tile shows; the rest is the builder."
         actions={
            <>
         ...
         <Stack sx={{ gap: 2, pt: 1 }}>
            {catalog.isSuccess && choices.size === 0 && (
               <Alert severity="info">
                  ...
                  this package declares one yet. Add a view to a source and this
                  list fills in.
               </Alert>
            )}
            <TextField

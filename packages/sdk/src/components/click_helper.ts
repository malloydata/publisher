 ...
 * point: a click can reach navigation from a React handler or from outside React
 * entirely — a `# drill` click arrives from the Malloy renderer as a DOM event —
 * and neither should have to be converted to the other first.
 */

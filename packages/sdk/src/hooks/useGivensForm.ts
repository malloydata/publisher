 ...
 * keyed by given name, with no source qualifier, because givens are
 * model-level rather than per-source. One entry per OVERRIDE, not per
 * declared given: the map starts empty and a missing key means "use the
 * model default".
 *

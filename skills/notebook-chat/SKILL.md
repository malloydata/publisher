---
name: notebook-chat
description: Steps to follow when the chat is bound to a notebook. The notebook's cells are the agent's primary context, answer from it, run its queries, and only reach for malloy_getContext when the user asks about something outside it.
---
# Notebook Chat Workflow

...
- [Query Construction](#query-construction)
  - [Wrong grain / fan-out](#wrong-grain--fan-out)
  - [Invented entity names](#invented-entity-names)
  - [Mismatched filter values](#mismatched-filter-values)
  - [Filtering on the wrong field](#filtering-on-the-wrong-field)
  - [Missing filters](#missing-filters)
  - [Misinterpreted entities](#misinterpreted-entities)
  - [Semantic ambiguity](#semantic-ambiguity)
  - [Fragile ad-hoc definitions](#fragile-ad-hoc-definitions)
  - [Hidden filters in views](#hidden-filters-in-views)
- [Result Interpretation](#result-interpretation)
  - [Implausible magnitudes](#implausible-magnitudes)
  - [Nulls distorting aggregations](#nulls-distorting-aggregations)
  - [Confusing count vs. count distinct](#confusing-count-vs-count-distinct)
  - [Percentage of what?](#percentage-of-what)
  - [Time period mismatches](#time-period-mismatches)
  - [Extremes of a rate on a tiny denominator](#extremes-of-a-rate-on-a-tiny-denominator)
- [Verification Signals](#verification-signals)
  - [Parts don't sum to the whole](#parts-dont-sum-to-the-whole)
  - [A total the model tells you not to take](#a-total-the-model-tells-you-not-to-take)
  - [Row count surprises](#row-count-surprises)
  - [Zero or empty results](#zero-or-empty-results)

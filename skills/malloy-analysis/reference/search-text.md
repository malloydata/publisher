...
- [Always send `search_text`](#always-send-searchtext)
- [Authoring `search_text` for entity targets](#authoring-searchtext-for-entity-targets)
- [Target-type decision guide](#target-type-decision-guide)
- [Non-obvious decomposition patterns](#non-obvious-decomposition-patterns)
- [Worked example](#worked-example)
- [Authoring `search_text` for `source` targets](#authoring-searchtext-for-source-targets)

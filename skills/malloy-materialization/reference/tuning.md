...
- [Step 2: Read the materialization history](#step-2-read-the-materialization-history)
- [Step 3: Analyze and recommend](#step-3-analyze-and-recommend)
- [Step 4: Apply (only once approved)](#step-4-apply-only-once-approved)

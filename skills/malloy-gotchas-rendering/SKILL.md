...
description: Read BEFORE adding chart annotations, formatting tags, or building dashboards. The common Malloy renderer mistakes - tag syntax, scale rules, sparkline setup, and big_value patterns.
---
<!--

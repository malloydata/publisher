...
- **A gated source cannot be materialized or pre-aggregated.** Keep `#(authorize)` off sources tagged `#@ persist` / `#@ preaggregate`; gate a source that is served live instead.

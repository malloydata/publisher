...
description: Read BEFORE writing views, queries, or notebooks. The common Malloy query mistakes - chart constraints, aggregate filters, joined field aliasing, method syntax, time truncation vs extraction.
---
<!--

...
- [Propose a source plan](#propose-a-source-plan)
  - [Base sources](#base-sources)
  - [Computed sources](#computed-sources)
  - [Dependencies](#dependencies)
  - [Deferred sources](#deferred-sources)
  - [User interaction](#user-interaction)
- [Propose definitions](#propose-definitions)
  - [For each base source](#for-each-base-source)
  - [For each computed source](#for-each-computed-source)
  - [Business logic questions](#business-logic-questions)

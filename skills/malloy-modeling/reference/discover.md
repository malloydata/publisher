...
- [Tools](#tools)
- [Workflow](#workflow)
- [Query File for Discovery](#query-file-for-discovery)
- [What to Capture](#what-to-capture)
  - [Table-Level](#table-level)
  - [Column-Level](#column-level)
  - [Data Quality](#data-quality)
  - [Data-Driven Validation](#data-driven-validation)
  - [Example Queries](#example-queries)
  - [Schema Shape](#schema-shape)
- [Computed Source Detection](#computed-source-detection)
- [Prior Art Detection](#prior-art-detection)
- [After Discovery](#after-discovery)
- [Done](#done)
- [Verify Source Joins](#verify-source-joins)
...
**In analysis-first mode:** There is no temp file. The analysis `.malloy` file IS your working file. It grows throughout the session and becomes the input for formalizing into a model. See `skill:malloy-visualization` for that workflow.

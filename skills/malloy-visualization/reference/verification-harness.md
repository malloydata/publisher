...
- [1. Mock `sdk/publisher.js`](#1-mock-sdkpublisherjs)
- [2. Drive it with Playwright and assert on the rendered DOM](#2-drive-it-with-playwright-and-assert-on-the-rendered-dom)
- [Gotchas (each cost a real debugging cycle)](#gotchas-each-cost-a-real-debugging-cycle)
...
(function () {
  ...
  window.Publisher = {
    ...
    // `reference/html-data-app-runtime.md`), NOT { data: rows }. If any tile renders

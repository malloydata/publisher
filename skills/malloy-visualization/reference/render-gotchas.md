...
- [No Fixed Scale on Measures](#no-fixed-scale-on-measures)
- [`# big_value` Needs `# label` on Each Measure](#-bigvalue-needs--label-on-each-measure)
- [Sparkline Setup](#sparkline-setup)
- [Comparison Deltas](#comparison-deltas)

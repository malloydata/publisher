...
- [Decision Tree: Which Chart?](#decision-tree-which-chart)
...
- [Layout Types](#layout-types)
  ...
  - [`# pivot`](#-pivot)
  - [`# transpose`](#-transpose)
  - [`# list` / `# list_detail`](#-list---listdetail)
  - [`# flatten`](#-flatten)
  - [`# table`](#-table)
- [Field Formatting Tags](#field-formatting-tags)
- [Utility Tags](#utility-tags)
- [Model-Level Defaults](#model-level-defaults)
- [viz.line_chart.defaults.y.independent=true](#vizlinechartdefaultsyindependenttrue)
- [viz.bar_chart.defaults.stack](#vizbarchartdefaultsstack)
- [Theming](#theming)
- [theme.palette.series = ["#14b3cb", "#e47404", "#1474a4"]](#themepaletteseries--14b3cb-e47404-1474a4)
- [theme.font.family = "Inter, sans-serif"](#themefontfamily--inter-sans-serif)
- [Advanced Patterns](#advanced-patterns)
  - [Sparklines in KPI Cards](#sparklines-in-kpi-cards)
  - [KPIs with Comparison Deltas](#kpis-with-comparison-deltas)
  - [Inline Mini-Charts in Table Rows](#inline-mini-charts-in-table-rows)
  - [Multi-Measure Series](#multi-measure-series)
  - [Hierarchical Drill-Down](#hierarchical-drill-down)
  - [Distribution (Histogram)](#distribution-histogram)
- [Patterns for Missing Chart Types](#patterns-for-missing-chart-types)
- [Chart Annotations on Queries with `nest:`](#chart-annotations-on-queries-with-nest)

...
- [The query contract](#the-query-contract)
- [Structure the app as modules, not one inline script](#structure-the-app-as-modules-not-one-inline-script)
- [Patterns that work](#patterns-that-work)
- [Context, auth, live reload (all automatic)](#context-auth-live-reload-all-automatic)
- [When the app fails](#when-the-app-fails)

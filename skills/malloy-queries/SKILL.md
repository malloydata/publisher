---
name: malloy-queries
description: Read BEFORE writing or debugging any Malloy query. Covers dates, aggregates vs dimensions, join paths, filters, string matching, chart annotations, and the errors a SQL habit produces.
---
<!--

...
| `PUT …/packages/{pkg}/models/dashboards/{slug}.malloy` | Write a dashboard file into the package and reload it: compile-first, atomic, restored on a failed reload, refused when the file changed since it was read (`expectedHash`). Gated by `frozenConfig`.                                                                                                                                                                                                                     |
